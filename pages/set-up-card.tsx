            ...
            <div id="setUpCard" className="relative bg-white rounded-2xl border border-gray-100 hover:shadow-sm">
                <div className="relative">
                    <div className="flex gap-3.5 z-10 fixed px-36 py-14 items-center">
                        ...
                        <path fillRule="evenodd" clipRule="evenodd" d="M12.3378 18.6653C12.1231 18.6653 11.9178 18.5766 11.7708 18.4203L7.98842 14.3922C7.69364 14.0795 7.70997 13.5872 8.02264 13.2932C8.33609 12.9992 8.82842 13.0147 9.12164 13.3274L12.33 16.7426L18.8695 9.58548C19.1604 9.26737 19.652 9.24637 19.9693 9.53571C20.2859 9.82504 20.3076 10.3174 20.0183 10.6339L12.9118 18.4117C12.7663 18.5719 12.5594 18.6637 12.3432 18.6653H12.3378Z" fill="white" stroke="white" stroke-width="0.25"/>
                        </motion.svg>
                        <motion.svg whileHover={{y: -4, scale: 1.1}} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
